...
coinbase.SignedSendCoin = async function(reqSendAdress, reqDestAdress, sendCrypt, sendAmount, callback) {
    console.log(`web3 version: ${web3.version}`)
...
coinbase.SignedSendAsset = async function(reqSendAdress, reqDestAdress, reqTokenContract, sendCrypt, sendAmount, callback) {
    console.log(`web3 version: ${web3.version}`)
    var myAddress = reqSendAdress;
    var destAddress = reqDestAdress;
    var transferAmount = sendAmount;
